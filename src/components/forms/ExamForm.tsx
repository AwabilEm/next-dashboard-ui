...
const TeacherForm = ({
  ...
  return (
    ...
    flex-col gap-8"
      onSubmit={onSubmit}
    >
      <h1 className="text-xl font-semibold">Create a new exams</h1>
     ...
     <select className="ring-[1.5px] ring-gray-300 rounded-md text-sm w-full p-2" {...register("sex")} defaultValue={data?.sex}>
